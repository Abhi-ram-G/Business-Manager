      ...
      {(() => {
        ...
        return (
          <button
            ...
            onClick={fabOnClick}
            title={fabTitle}
            className={`fixed bottom-20 right-4 sm:right-6 z-[60] w-14 h-14 rounded-full ${fabBgColor} active:scale-95 text-white shadow-xl flex items-center justify-center transition-all duration-200 hover:scale-105 border-2 border-white/20`}
          >

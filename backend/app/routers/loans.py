...
from ..models import LoanGiven, LoanReceived
from ..schemas import (
    EMICollectRequest,
    LoanGivenCreate,
    LoanGivenUpdate,
...
@router.post("/given", status_code=status.HTTP_201_CREATED)
...
@router.delete("/given/{loan_id}", status_code=status.HTTP_204_NO_CONTENT)
...
@router.delete("/received/{loan_id}", status_code=status.HTTP_204_NO_CONTENT)
